...
<div class="btn-toolbar">
    <button class="btn btn-primary" onClick="location='<?php echo U('list_navs');?>'"><i class="icon-list"></i> 导航列表</button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
        <form action="" method="post" enctype="multipart/form-data">导航分类</label>
            <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>"/>
            <select name="fid" class="input-xlarge">
              <option value='0'>!!主导航</option>
              <?php echo ($navs); ?>
            </select>
            <label>导航标题</label>
            <input type="text" name="name" value="<?php echo ($data["name"]); ?>" class="input-xxlarge">
            <label>导航路径</label>
            <input type="text" name="url" value="<?php echo ($data["url"]); ?>" class="input-xxlarge">
            <label>导航英文</label>
            <input type="text" name="ename" value="<?php echo ($data["ename"]); ?>" class="input-xxlarge">
            <label>导航图片</label>
