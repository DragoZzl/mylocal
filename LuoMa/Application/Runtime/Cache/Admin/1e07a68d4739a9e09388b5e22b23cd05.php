...
<div class="btn-toolbar">
    <button class="btn btn-primary" onClick="location='<?php echo U('add_nav');?>'"><i class="icon-plus"></i>新建导航</button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <table class="table">
      ...
      <tbody>
      <?php if(is_array($all_navs)): $i = 0; $__LIST__ = $all_navs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
            <td><?php echo ($v["cid"]); ?></td>
            <td><?php echo ($v["name"]); ?></td>
            <td><?php echo ($v["ename"]); ?></td>
            <td>
                <a href="<?php echo U('add_nav',array('id'=>$v['cid']));?>"><i class="icon-pencil"></i></a>
                <a href="<?php echo U('list_nav',array('id'=>$v['cid']));?>"><i class="icon-remove"></i></a>
            </td>
