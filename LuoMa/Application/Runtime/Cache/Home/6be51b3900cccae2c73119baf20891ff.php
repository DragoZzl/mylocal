	...
	<div class="con_mid w1000">
     ...
     <a href=""><?php echo ($nav["0"]["name"]); ?></a>
	  ...
	  <div class="con_l fl">
	    ...
	    <div class="con_r fr news">
	      <ul class="news-ul">
			<?php if(is_array($this_news)): $i = 0; $__LIST__ = $this_news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="pb-10 clear">
	      			<div class="fl left">
	      				<a href="javascript:;">
	      			...
	      			<div class="fr right">
	      				<h4 class="news-title pr">
	      					<?php echo ($v["title"]); ?>
	      				<span class="pa" style="right:0; color:#1a1a1a; font-size:14px;"><?php echo date("Y-m-s",$v['time']) ?></span>
	      				</h4>

						<p><?php echo ($v["desc"]); ?></p>
						<a href=""class="fr mt-30">MORE</a>
	      			</div>
